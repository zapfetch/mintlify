...
| Scale       | **$167 / mo**      | 500,000      | 50          | Production agents, RAG stacks   |
| Business    | **$749 / mo**      | 2,500,000    | 100         | Mid-market workloads            |
| Enterprise  | from **$1,250 / mo** | custom     | custom      | Annual, SLA, ZDR, dedicated IPs |

Credits reset monthly and do not roll over. If you need large volumes of
rollover credits, talk to us about an Enterprise contract.
...
- **Scale / Business / Enterprise** prices are **permanent**. No
  ramp-up, no "promo period ended" surprises — these are the published
  rates going forward.
...
Add-ons are separate SKUs; they stack on top of any plan from Pro up.
...
- **Zero Data Retention** — Raw content is dropped within 7 seconds,
  never written to disk. Business+.
- **99.9% Uptime SLA** — Contractual service credits on downtime.
  Business+.
- **Priority Queue / Dedicated IP Pool** — Isolated queues and IP pools
  for latency-sensitive or high-volume workloads.

See the [pricing page](/pricing) for add-on rates, or email
