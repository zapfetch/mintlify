...
- No silent overage. You'll never get a surprise bill — ZapFetch refuses
  to run above your cap, full stop. Once you hit zero, requests return
  `402` until the next monthly reset or a manual top-up.

If you need a larger committed cap or custom billing terms, email
`sales@zapfetch.com`.
